...
javac -cp "%CP%" -d "%BIN_DIR%" "%SRC_DIR%\com\library\repository\BookRepository.java" "%SRC_DIR%\com\library\service\BookService.java" "%SRC_DIR%\com\library\Main.java"
if %errorlevel% neq 0 (
...
java -cp "%BIN_DIR%;%RESOURCES_DIR%;%CP%" com.library.Main
